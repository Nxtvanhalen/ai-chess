-- ============================================================================
-- Migration 010: Revert RLS to migration 007 policies
-- Migration 008 broke anonymous/anon-key access by removing user_id IS NULL checks.
-- The app uses the anon key client for database.ts operations, which requires
-- these permissive policies. Service role clients bypass RLS entirely.
-- ============================================================================
